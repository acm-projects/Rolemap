    ...
    <div className="relative h-screen overflow-hidden w-full bg-[#f0f8f8] p-3 flex flex-col">
      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col justify-between flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 mb-2">
          ...
          {/* GitHub Connect */}
          {githubVerified ? (
            <div className="pixel-border flex flex-col items-center justify-center gap-3 p-6 border-t-[#7ab3b3] border-l-[#7ab3b3] border-r-[#4e8888] border-b-[#4e8888] bg-[#e8f4f4]">
              <div className="w-14 h-14 flex items-center justify-center pixel-border border-t-[#7ab3b3] border-l-[#7ab3b3] border-r-[#4e8888] border-b-[#4e8888] bg-[#2d5050]">
              ...
              <span className="text-xl text-[#2d5050] font-jersey text-center">GitHub Connected</span>
              <div className="flex items-center gap-2 text-[#4e8888]">
                <CheckCircle size={16} />
            ...
            <button
              ...
              disabled={uploading}
            >
              <div className="w-14 h-14 flex items-center justify-center pixel-border border-t-[#d4e8e8] border-l-[#d4e8e8] border-r-[#7ab3b3] border-b-[#7ab3b3] bg-[#2d5050]">
                <svg viewBox="0 0 24 24" className="w-7 h-7 fill-white" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0 0 24 12c0-6.63-5.37-12-12-12z" />
                </svg>
              </div>
              <span className="text-xl text-[#2d5050] font-jersey text-center">Connect GitHub</span>
              <span className="text-md text-[#4e8888] font-jersey text-center">Import your commit history and repos</span>
            </button>
          )}
        </div>
